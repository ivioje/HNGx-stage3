...
const TouchImageCard = ({ image, isDragging }) => {


	return (
        <div
        className={`${isDragging === image.id ? 'dragging': ''} relative flex flex-col items-center justify-center p-2`}
     >
        ...
        <div className="grid bg-no-repeat bg-cover bg-center rounded-md shadow-md xs:hidden w-[300px] h-[200px] cursor-grab"
